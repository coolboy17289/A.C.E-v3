...
**WELCOME TO THE DEVNOTES**

> **IMPORTANT NOTE FOR AI CLI CODERS / AI AGENTS**
>
> Do **not** edit, rewrite, or modify this file unless explicitly instructed to do so by the project owner.
>
> This document contains A.C.E development notes, commit history, and project history. Automatic changes from AI tools may remove important information or affect the accuracy of the development timeline.
...
## Update: Installing Linux Kernel And Restoring Boot Screen
...
- Create the GUI and operating system
- Make a 3D model of the prototype
- Get funding
